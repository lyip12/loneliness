...
function questionaire(){
    ...
    var q = "<p class='smalltext' data-aos='fade-in'><b>"+q1[1]+"</b></p><form id='question"+q1[0]+"'data-aos='fade-in'><input type='radio' name='q1' value=0> Never<br><input type='radio' name='q1' value=1> Rare<br><input type='radio' name='q1' value=2> Sometimes<br><input type='radio' name='q1' value=3> Always</form>"
    ...
    d3.select("#question2").on("change", function () {
        ...
        document.getElementById("q2").innerHTML = q;
        var q = "<p class='smalltext' data-aos='fade-in'>"+q3[1]+"</p><form id='question"+q3[0]+"'data-aos='fade-in'><input type='radio' name='group-stack' value=0> Never<br><input type='radio' name='group-stack' value=1> Rare<br><input type='radio' name='group-stack' value=2> Sometimes<br><input type='radio' name='group-stack' value=3> Always</form>"
    ...
    d3.select("#question4").on("change", function () {
        ...
        var q = "<p class='smalltext' style='color:#404040;'>"+q4[1]+"<br><br>"+a[a4]+"</p>"
        document.getElementById("q3").innerHTML = q;
